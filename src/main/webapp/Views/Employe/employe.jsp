...
<div class="px-10 py-10">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all the Employees in your account including their name,
                title,
                email and more.</p>
        </div>
        <form class="m-0" action="<%= request.getContextPath() %>/employee" method="post">
                    ...
                    <div class="flex items-center px-6 py-4 md:mx-auto md:max-w-3xl lg:mx-0 lg:max-w-none xl:px-0">
                        <div class="w-full">
                            ...
                            <div class="relative">
                                ...
                                <input id="search" name="matricule"
                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <c:forEach var="employee" items="${employees}">
                            <tr>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${employee.matricule}</td>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${employee.birthDate}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${employee.mobile}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${employee.recruitmentDate}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">${employee.email}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    <button onclick="populate_Update('${employee.matricule}','${employee.firstName}','${employee.lastName}','${employee.birthDate}','${employee.mobile}','${employee.recruitmentDate}', '${employee.email}')"
                                            class="text-indigo-600 hover:text-indigo-900">Edit
                                    </button>
                                    <a class="text-black">|</a>
                                    <button onclick="populateDelete('${employee.matricule}')"
                                            class="text-red-400 hover:text-red-700">Delete
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
            ...
            <div id="addOverlay"
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:w-full sm:max-w-lg">
                    <div class="text-center pt-5 block font-semibold text-2xl self-start text-gray-700">
                        <h1 class="leading-relaxed">Add Employee</h1>
                    </div>
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        <label for="matricule"
                                               class="block text-sm font-medium text-gray-700">Matricule</label>
                                        <input type="text" name="matricule" id="matricule"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Employee Matricule" required>
                                    </div>
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        <label for="mobile"
                                        ...
                                        <input type="tel" name="mobile" id="mobile"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Employee Mobile" required>
                                    </div>
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="firstName" id="firstName"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Employee FirstName" required>
                                    </div>
                                    ...
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="lastName" id="lastName"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Employee LastName" required>
                                    </div>
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        <label for="email"
                                    ...
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        ...
                                        <input type="date" name="birthDate" id="birthDate"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Employee BirthDate" required>
                                    </div>
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        <label for="recruitmentDate"
                                               class="block text-sm font-medium text-gray-700">Recruitment Date</label>
                                        <input type="date" name="recruitmentDate" id="recruitmentDate"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Employee Recruitment Date" required>
                                    </div>
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div id="deleteOverlay"
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                    <form action="<%= request.getContextPath()%>/employeeDelete" method="post">
                        <div class="sm:flex sm:items-start">
                            <input type="hidden" id="deleteCode" name="matricule">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Delete
                                    Employee</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Are you sure you want to Delete This Employee? All
                                        of
                    ...
                    <form action="<%= request.getContextPath()%>/employeeUpdate" method="POST">
                        <div class="overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        <label for="updateMatricule" class="block text-sm font-medium text-gray-700">Matricule</label>
                                    ...
                                    <div class="p-4 col-span-6 sm:col-span-3">
                                        <label for="updateRecruitmentDate"
                                               class="block text-sm font-medium text-gray-700">Birth
                                            Date</label>
                                        <input type="date" name="recruitmentDate" id="updateRecruitmentDate"
                                               class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                               placeholder="Client BirthDate" required>
                                    </div>
